/**
 * Source: https://use.ai/_next/static/chunks/auth-modal.service-Cuedadps.js
...
import { I as r } from "./analytics.service-9oUGcSKY.js";
import { m as i } from "./freemium-funnel.util-BsrrWeXM.js";
import { i as a } from "./mixpanel-B_WP0jc-.js";
import { t as o } from "./auth.store-DeUNDeDH.js";
import { r as s } from "./raw-history.util-BleUn4RV.js";
import { n as c } from "./user-data.provider-D1zgVZeU.js";
import { t as l } from "./use-history-backed-flag.hook-BJi3PAz-.js";
var u = e(t(), 1),
  d = `authmodal`,
  f = 6e5,
  p = () => { let { isAuthModalOpen: e, authModalVariant: t, openSignInModal: p, openSignUpModal: m, closeAuthModal: h,
      switchToSignIn: g, switchToSignUp: _, signupModalSource: v, setSignupModalSource: y } = o(), { session: b } = c(),
      x = b.isAuthenticated, S = b.isPending, C = o(e => e.isPostAuthTransition), w = n()?.get(d), { requestClose: T,
      ...
      t.searchParams.delete(d), s(window.history.state, t.toString()) }, [x, S, e, p, w, C]), (0, u.useEffect)(
