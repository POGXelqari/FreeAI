/**
 * Source: https://use.ai/_next/static/chunks/select-theme.service-DWChOL78.js
 * Module: select-theme.service
 * Extracted & Beautified
 */

import "./rolldown-runtime-C0FnF6B9.js";
import { i as e, r as t } from "./framework-D-uKrMmN.js";
import { n } from "./dist-CQDSGHYK.js";
import { h as r } from "./analytics-hooks.service-fJFOoVJi.js";
e();
var i = t(),
  a = e => (0, i.jsx)(`svg`, { xmlns: `http://www.w3.org/2000/svg`, viewBox: `0 0 24 24`, color: `#000000`,
    fill: `none`, ...e, children: (0, i.jsx)(
  ...
  o = e => (0, i.jsxs)(`svg`, { xmlns: `http://www.w3.org/2000/svg`, viewBox: `0 0 24 24`, color: `#000000`,
    fill: `none`, ...e, children: [(0, i.jsx)(
    `path`, { d: `M17 12C17 14.7614 14.7614 17 12 17C9.23858 17 7 14.7614 7 12C7 9.23858 9.23858 7 12 7C14.7614 7 17 9.23858 17 12Z`,
      stroke: `currentColor`, strokeWidth: 1.5 }), (0, i.jsx)(
  ...
  s = () => { let { theme: e, resolvedTheme: t, setTheme: i } = n(), { trackThemeSwitched: a } = r(); return { theme: e,
      resolvedTheme: t, handleChangeTheme: () => { switch (t) {
          case `dark`:
            a(`light`), i(`light`); break;
          default:
            a(`dark`), i(`dark`) } }, setTheme: i } };
