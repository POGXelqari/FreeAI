...
var T = a(`moon`, [
  ...
  A = e(n()),
  j = e => (0, D.jsxs)(`svg`, { xmlns: `http://www.w3.org/2000/svg`, viewBox: `0 0 24 24`, color: `#000000`,
    fill: `none`, ...e, children: [(0, D.jsx)(`circle`, { cx: 12, cy: 12, r: 10, stroke: `currentColor`,
      strokeWidth: 1.5 }), (0, D.jsx)(
  ...
  M = (e, t) => {
    (0, A.useEffect)(() => { if (!e) return; let n = e => { t.current?.contains(e.target) || e
      .preventDefault() }; return window.addEventListener(`wheel`, n, { passive: !1 }), window.addEventListener(
      ...
      collisionPadding: 16, "data-testid": `language-selector-menu`, ref: S, children: l.map(e => (0, D.jsx)(
        ...
        (y, { align: `start`,
          ...
          children: l.map(e => (0, D.jsx)(_, { onClick: () => { a.handleChangeLanguage(e.value) }, children: (0,
              D.jsxs)(`div`, { className: `flex w-full items-center justify-between`, children: [(0, D
                .jsx)(`span`, { children: e.label }), a.currentLanguage === e.value && (0, D.jsx)(
                o, { className: `h-4 w-4` })] }) }, e.value)) })
      ] }) },
  P = t({ default: () => L }),
  F = `hover:text-accent dark:hover:text-accent text-sm text-gray-600 dark:text-gray-400`,
  I = `text-foreground mb-1 text-xs font-semibold tracking-wider uppercase`,
  L = () => { let e = new Date().getFullYear(),
      t = f(`Footer`),
      n = i().get(`embed`) === `app`,
      r = w(); return (0, D.jsx)(`footer`, { className: `border-border bg-paper mt-auto w-full border-t py-10`,
      style: { paddingBottom: `calc(2.5rem + var(--cookie-banner-offset, 0px))` }, children: (0, D.jsxs)(
      `div`, { className: `mx-auto max-w-7xl px-4 sm:px-6 lg:px-8`, children: [(0, D.jsxs)(
        `div`, { className: `flex flex-col gap-10 md:flex-row md:justify-between`, children: [(0, D.jsx)(
            `ul`, { "aria-label": `Company information`,
              className: `flex list-none flex-col gap-2 pl-0`, children: (0, D.jsx)(
              `li`, { children: (0, D.jsx)(
                  S, { className: `h-4.5 w-auto text-black dark:text-white [&_path]:fill-current` }) }) }
            ), !n && (0, D.jsxs)(`ul`, { "aria-labelledby": `footer-product-heading`,
        ...
        `div`, { className: `border-border mt-10 flex flex-col items-start gap-4 border-t pt-6 md:flex-row md:items-center md:justify-between`,
          children: [(0, D.jsxs)(`div`, { className: `flex flex-col gap-1`, children: [(0, D.jsx)(
            `p`, { className: `text-xs text-gray-500 dark:text-gray-400`, children: t(
                `footer_copyright`, { currentYear: e.toString(),
                companyName: `Use AI Inc.` }) }), (0, D.jsx)(
            `p`, { className: `text-xs text-gray-500 dark:text-gray-400`, children: t(
                `footer_disclaimer`) })] }), (0, D.jsxs)(
          `div`, { className: `flex items-center gap-3 md:flex-row-reverse`, children: [(0, D.jsx)(
              N, { className: `hover:text-accent border-0 bg-transparent py-0 text-gray-600 hover:border-transparent dark:bg-transparent dark:text-gray-400`,
                icon: (0, D.jsx)(c, { className: `size-4.5 text-gray-500 dark:text-gray-400` }),
                variant: `button` }), (0, D.jsx)(k, {})] })] })] }) }) };
