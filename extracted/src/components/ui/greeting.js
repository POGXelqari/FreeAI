/**
 * Source: https://use.ai/_next/static/chunks/greeting-BMnEPWM2.js
 * Module: greeting
...
import { a as r } from "./experiment-client.service-Dbg--_Jv.js";
import { h as i } from "./billing-CclPhhLo.js";
...
import { i as l } from "./mixpanel-CkBALibP.js";
import { t as u } from "./utils-DBS9-MOh.js";
import { t as d } from "./intl-5y7Gu4iP.js";
import { r as f } from "./is-mobile.service-c24xKO50.js";
import { n as p } from "./experiment.provider-CQRJZnpd.js";
import "./client-DWC7O25X.js";
import { r as m } from "./chat.store-CVJElyGt.js";
import { t as h } from "./auth.store-CecpbI3z.js";
import { t as g } from "./site-route.interface-DlOSDxTR.js";
import { t as _ } from "./logo-icon-C5Mo55YO.js";
import { t as v } from "./logo-icon-white-QiZ2Ybc-.js";
import { a as y } from "./model-catalog.provider-C5iwWYsc.js";
import { t as b } from "./use-user.hook-DIvUDXD9.js";
import { n as x, t as S } from "./use-guest-sidebar-menu.hook-D4ZKIqpw.js";
import { n as C } from "./use-incognito-chat.hook-Dun56_qv.js";
import { t as w } from "./use-auth-known.hook-C1WWcve_.js";
import { n as T } from "./initial-auth-state.provider-DUS-CXUE.js";
import { n as E } from "./open-after-viewport-settle.util-BfKU5lGX.js";
import { n as D } from "./chat-landing-variant.provider-CFxvAtmo.js";
import { t as O } from "./set-chat-model-DIyq3S5u.js";
import { r as k } from "./use-display-user.hook-sY0IkKdE.js";
import { t as A } from "./model-selector-CHLHhIlL.js";
import { t as j } from "./use-traffic-detection.hook-CKzLJPTv.js";
var M = e => ({ variant: `OFF`, isEnabled: !1, isInExperiment: !1, trackExperimentView: () => {} }),
  N = e(t(), 1),
  P = n(),
  F = e => { let { onHeightChange: t, sticky: n = !0, centered: r } = e, i = o(`Sidebar`), { isEnabled: a } = S(), s = (
        0, N.useRef)(null), c = m(e => e.promptSuggestionsExpanded), l = !n && c, p = f(), { isBingTraffic: h } = j(),
      _ = r == null ? h : !r, v = (0, N.useCallback)(e => { if (s.current?.disconnect(), s.current = null, !e) { t?.(
            0); return } t && (s.current = new ResizeObserver(() => { t(e.offsetHeight) }), s.current.observe(e)) }, [
        t]); return (0, P.jsx)(`div`, { className: u(`flex items-center justify-center pt-2`, n &&
        `bg-paper sticky bottom-0`, l && `invisible`, p && !_ ? `px-2` : `px-4`), "data-hide-on-keyboard": n ? `` :
        void 0, ref: v, style: { paddingBottom: `calc(0.5rem + var(--cookie-banner-offset, 0px))` }, children: (0, P
        .jsx)(`p`, { className: u(`mx-auto max-w-[750px] text-center font-normal`, _ ?
          `desktop:text-[14px] text-[12px] text-gray-500 dark:text-gray-400` :
          `text-[14px] text-gray-700 dark:text-gray-300`), children: i.rich(a ? `guest_menu_disclaimer` :
          `sidebar_disclaimer`, { terms: e => (0, P.jsx)(d, { className: `underline`, href: g.TERMS,
              children: e }), privacy: e => (0, P.jsx)(d, { className: `underline`, href: g.PRIVACY,
              children: e }) }) }) }) },
  I = e => { let { collapsed: t } = e; return (0, P.jsx)(`div`, { className: u(
  ...
  L = () => { let e = p(r.MAIN_PAGE_NEW_FEATURE_BADGE, `OFF`),
      { isMainPage: t } = x(),
      n = e === `B`,
      a = t && (e === `A` || e === `B`); return i({ experimentName: r.MAIN_PAGE_NEW_FEATURE_BADGE, experimentValue: e,
      shouldTrack: a }), { variant: e, isEnabled: n, isInExperiment: a, trackExperimentView: () => {} } },
  R = `new-feature-badge-dismissed`,
  z = `new-feature-badge-try-now-clicked`,
  B = `new-feature-badge-target-model`,
  V = () => { let e = o(`Sidebar`),
      { isEnabled: t } = L(),
      n = m(e => e.selectedModel),
      r = m(e => e.isModelHydrated),
      { data: i } = s(),
      c = !!i?.user && i.user.type !== `guest`,
      { mutateAsync: u } = O(),
      { newFeatureBadge: d } = y(),
      [f, p] = (0, N.useState)(() => localStorage.getItem(R) === `true` || sessionStorage.getItem(z) === `true`),
      g = { targetModel: d.byCurrentModel[n] ?? d.defaultTargetSlug },
      _ = (0, N.useCallback)(e => { m.getState().setSelectedModel(e), u({ model: e }).catch(() => {}) }, [u]);
    (0, N.useEffect)(() => { if (!c || !r || sessionStorage.getItem(z) !== `true`) return; let e = sessionStorage
      ...
      _
    ]); let v = (0, N.useCallback)(() => { localStorage.setItem(R, `true`), p(!0) }, []),
      b = (0, N.useRef)(null);
    (0, N.useEffect)(() => { if (!r) return; let e = b.current; if (b.current = n, e === null || e === n) return; let
      ...
      n === t && v() }, [n, r, v, d]); let x = (0, N.useCallback)(() => { c ? (_(g.targetModel), v()) : (sessionStorage
        .setItem(z, `true`), sessionStorage.setItem(B, g.targetModel), h.getState().openSignInModal(l
          .NEW_FEATURE_BADGE)) }, [c, g.targetModel, _, v]); return !t || f ? null : (0, P.jsxs)(
    `div`, { className: `mt-3 mb-5 flex items-center gap-2 px-3 sm:mt-0`, children: [(0, P.jsx)(
        ...
        (0, P.jsxs)(`button`, { className: `text-accent flex shrink-0 items-center gap-1 text-xs font-medium`,
          ...
          a, { className: `h-3.5 w-3.5`, strokeWidth: 2.5 })] }), (0, P.jsx)(`button`, { "aria-label": e(
  ...
  U = e => { let { user: t } = b(), { name: n } = k(), r = (0, N.useMemo)(() => { let e = n ?? t?.name; return e ? e
  ...
  W = class extends N.Component { constructor(e) { super(e), this.state = { hasError: !
          ...
          `Greeting component error boundary caught error:`, e), c(e, `render`) } render() { return this.state
          ...
          `div`, { className: `mx-auto flex max-w-3xl flex-col items-center px-8 text-center`, "data-testid": `greeting-error-fallback`,
            children: [(0, P.jsx)(_, { className: `dark:hidden`, height: 36, style: { marginBottom: `20px` },
          ...
          .children } },
  G = (0, N.memo)(({ user: e, initialChatModel: t }) => { let n = o(`Chat`),
      r = !!e && e.type !== `guest`,
      ...
      l = w(a, c, r),
      d = f(),
      { isIncognito: p } = C({ isAuthenticatedHint: r }),
      h = A(t),
      g = m(e => e.isTextareaTooltipVisible),
      _ = m(e => e.textareaTooltipHeight),
      v = m(e => e.isDeepResearchMode),
      { modes: y } = E(),
      b = y ? !!y.isDeepResearchMode : v,
      x = g && d ? _ + 8 : 0,
      S = p ? `chat_greeting_incognito` : b ? `chat_greeting_deep_research` : !r && l ?
      `chat_greeting_personal_assistant` : i; return (0, P.jsxs)(`div`, { className: u(
        `dark:text-foreground mx-auto mb-2 flex max-w-3xl flex-col items-center gap-2 text-center text-[#3D3D3D]`,
        d ? `px-0` : `px-8`), "data-testid": `greeting-component`, style: { transform: `translateY(-${x}px)`,
        transition: `transform 0.2s ease-out` }, children: [(0, P.jsx)(`div`, { className: `text-2xl font-medium`,
        style: { paddingBottom: d || !r && h ? `0px` : `28px` }, children: n(S) }), !r && h && (0, P.jsx)(
        `div`, { className: u(`text-base text-gray-500`, d ? `pb-0` :
