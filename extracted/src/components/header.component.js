/**
 * Source: https://use.ai/_next/static/chunks/header.component-BJY8EK6h.js
...
import { i as s } from "./rest-api-DNPFxXXP.js";
...
import { n as p, t as m } from "./intl-5y7Gu4iP.js";
import { r as h } from "./is-mobile.service-c24xKO50.js";
import { t as g } from "./global.store-DsM3x4UJ.js";
import { t as _ } from "./auth.store-CecpbI3z.js";
import { t as v } from "./site-route.interface-DlOSDxTR.js";
...
import { t as x } from "./use-guest-sidebar-menu.hook-D4ZKIqpw.js";
import { r as S, t as C } from "./use-page-scroll.hook-DpmNgPID.js";
import { i as w } from "./chat-route.util-DIaoD1cB.js";
import { t as T } from "./app.constant-CQOe5N6O.js";
import { t as E } from "./help-route.util-DOvwIYGh.js";
import { n as D, t as O } from "./config.model-C-TFE2oV.js";
var k = e(t(), 1),
  A = n(),
  j = k.forwardRef(({ className: e, position: t = `static`, ...n }, r) => (0, A.jsx)(`nav`, { ref: r, className: f(
...
var M = k.forwardRef(({ className: e, ...t }, n) => (0, A.jsx)(`div`, { ref: n, className: f(`flex items-center`, e),
  ...t }));
M.displayName = `NavbarBrand`;
var N = k.forwardRef(({ className: e, justify: t = `start`, ...n }, r) => (0, A.jsx)(`div`, { ref: r, className: f(
    `flex items-center`, t === `start` && `justify-start`, t === `center` && `justify-center`, t === `end` &&
    `justify-end`, e), ...n }));
N.displayName = `NavbarContent`;
var P = k.forwardRef(({ className: e, ...t }, n) => (0, A.jsx)(`div`, { ref: n, className: f(`flex items-center`, e),
  ...t }));
  ...
  async e => await (await s.post(O.API_CONFIG, { json: e })).json(), L = e => a({ mutationKey: [D.CONFIG_MUTATION],
    ...
    z = () => i(R()), B = e => (window.addEventListener(`scroll`, e, { passive: !0 }), () => window
      ...
      S(se); let $ = () => { let e = T.some(e => s.get(e) === `true`),
        ...
        a(e ? u.IMAGE_FUNNEL : u.URL, t) }; return i.hideHeader || oe || ie ? null : (0, A.jsx)(`div`, { className: f(
          `fixed right-0 left-0 z-50`, `top-0`, I || L ? `fixed` : X ? `sticky` : `relative`, X &&
          `backdrop-blur-xl`, Z && H), children: (0, A.jsxs)(j, { className: f(
          ...
          position: `sticky`, ref: e, children: [(0, A.jsx)(m, { "aria-label": g(`home_link_label`), href: i
              ...
              .div, { className: f(`flex items-center`, Z && `gap-2`),
                transition: { type: `spring`, stiffness: 400, damping: 10 },
                whileHover: { scale: 1.05 }, children: [Z && (0, A.jsxs)(A
                  .Fragment, { children: [(0, A.jsx)(y, { className: f(`h-5 w-5 shrink-0`,
                          Q && `dark:hidden`) }), Q && (0, A.jsx)(
                      te, { className: `hidden h-5 w-5 shrink-0 dark:block` })] }), (0, A.jsx)
                  (ne, { className: f(Z || z ? `h-4 w-auto` : `h-4 w-auto sm:h-6 md:h-8`, Z &&
                      `mb-[3px]`, Q && `dark:hidden`) }), Q && (0, A.jsx)(b, { className: f(
              ...
              .jsx)(P, { children: (0, A.jsx)(`div`, { className: `flex flex-col items-end gap-0.5`,
                children: i.isAuthKnown ? i.isAuthedUser ? (0, A.jsx)(m, { href: `/`,
                  children: (0, A.jsx)(d, { size: Z ? `chip` : void 0, variant: `cta`,
                      children: g(`btn_go_to_chat`) }) }) : Z ? (0, A.jsx)(d, { onClick: $,
                  size: `chip`, variant: `cta`, children: g(`btn_sign_in`) }) : (0, A.jsx)(
                d, { onClick: $, size: Z ? `chip` : void 0, variant: `cta`, children: g(
